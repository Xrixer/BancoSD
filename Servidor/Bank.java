...
public class Bank {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// hace backup de archivo correcto, de existir, por si ocurre algun error, tener
			// respaldo
			// HACER
		...
		try {
			...
			// se registra bajo el docum "00000000", que es un numero de cedula que nadie
			// puede tener
			...
			while ((linea = br.readLine()) != null) {
				...
				us = new UsuarioImpl(userData[0], userData[1], userData[2], userData[3], userData[4],
